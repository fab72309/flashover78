...
import { getSdis78Files } from '../services/firebaseService';
import LoadingSpinner from '../components/LoadingSpinner';

interface Sdis78DocumentsProps {
  onBack: () => void;
}
...
export default function Sdis78Documents({ onBack }: Sdis78DocumentsProps) {
  ...
  useEffect(() => {
    const loadFiles = async () => {
      try {
        const filesList = await getSdis78Files();
        setFiles(filesList);
      } catch (err) {
