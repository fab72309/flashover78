...
import { getLecturesFiles } from '../services/firebaseService';
import LoadingSpinner from '../components/LoadingSpinner';

interface LecturesDocumentsProps {
  onBack: () => void;
}
...
export default function LecturesDocuments({ onBack }: LecturesDocumentsProps) {
  ...
  useEffect(() => {
    const loadFiles = async () => {
      try {
        const filesList = await getLecturesFiles();
        setFiles(filesList);
      } catch (err) {
